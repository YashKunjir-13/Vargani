import { PrismaClient, PaymentChannel, PaymentStatus } from "../../../packages/backend-database/src/generated/client";
...
async function main() {
  ...
  try {
    ...
    // Clear prior test payments for clean evidence run
