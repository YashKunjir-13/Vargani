    ...
    try {
        ...
        const tmplV1 = await prisma.receiptTemplate.create({
            data: {
                ...
                templateType: client_1.TemplateType.RECEIPT,
                version: 1,
                sourceFileUrl: "https://storage.pautipustak.org/tenants/org-1/receipt_v1.png",
                detectionStatus: client_1.TemplateDetectionStatus.AUTO_DETECTED,
                isActive: true,
                fieldMap: [
        ...
        const updatedV2 = await prisma.receiptTemplate.update({
            where: { id: tmplV2.id },
            data: {
                detectionStatus: client_1.TemplateDetectionStatus.MANUALLY_CALIBRATED,
                fieldMap: [
...
//# sourceMappingURL=templates-integration-proof.js.map