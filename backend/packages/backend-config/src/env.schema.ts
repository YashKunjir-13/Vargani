...
export const EnvironmentSchema = z.object({
  ...
  RAZORPAY_KEY_ID: z.string().min(1, "RAZORPAY_KEY_ID is required to accept InApp payments"),
  RAZORPAY_KEY_SECRET: z.string().min(1, "RAZORPAY_KEY_SECRET is required to accept InApp payments"),
  RAZORPAY_WEBHOOK_SECRET: z.string().min(1, "RAZORPAY_WEBHOOK_SECRET is required to verify Razorpay webhooks"),
