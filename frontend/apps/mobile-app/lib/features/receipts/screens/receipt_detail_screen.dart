            ...
            children: [
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      await PdfDownloadUtils.downloadReceiptPdf(
                          context, dio, receiptId, receipt.receiptNumber);
                    },
                      ...
                      child: Row(
                        children: const [
                          Icon(Icons.download_rounded,
                              size: 18, color: AppColors.amountTerracotta),
                          SizedBox(width: 6),
                          Text(
                            'PDF',
                            style: TextStyle(
                  ...
                  InkWell(
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('Sharing digital receipt...')),
                      );
                    },
                    borderRadius: BorderRadius.circular(12),
                    child: Container(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (receipt.contactNumber != null &&
                                receipt.contactNumber!.isNotEmpty)
                              Text(
                                receipt.contactNumber!.startsWith('+')
                                    ? receipt.contactNumber!
                                    : '+91 ${receipt.contactNumber!}',
                                style: const TextStyle(
                                  color: AppColors.textSecondaryLight,
                                  fontSize: 13,
                                ),
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: AppColors.amberBoxBorder,
                                    width: 1.5),
                              ),
                              child: Column(
                                children: [
              ...
              if (receipt.status != ReceiptStatus.voided)
                PermissionGuard(
                  ...
                  fallbackTooltip:
                      'Auditor or Admin role required to void official receipt',
                  child: AppButton(
                    label: 'Void Receipt',
                    ...
                    onPressed: () async {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(ok
                                ? 'WhatsApp resend initiated'
                                : 'Failed to resend WhatsApp'),
