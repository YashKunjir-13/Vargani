      ...
      body: asyncReceipts.when(
        ...
        data: (receipts) {
          ...
          final pendingCount = receipts
              .where((r) => r.receiptNumber.startsWith('PENDING'))
              .length;
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: AppColors.amberBoxBorder, width: 1.5),
                ),
                child: Row(
                  children: [
                    Container(
              ...
              if (filtered.isEmpty)
                ...
                ...filtered.map((receipt) {
                  final initial = receipt.mandalName.isNotEmpty
                      ? receipt.mandalName[0]
                      : 'M';
