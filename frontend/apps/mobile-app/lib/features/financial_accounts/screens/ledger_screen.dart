...
class LedgerScreen extends ConsumerWidget {
  ...
  void _showRecordDepositDialog(BuildContext context, WidgetRef ref) {
    ...
    final depositorController =
        TextEditingController(text: 'Priya Deshmukh (Treasurer)');
        ...
        content: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  labelText: 'Bank Ref / Counter Slip #',
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  labelText: 'Deposited By', prefixIcon: Icon(Icons.person)),
            ),
          ],
        ),
        actions: [
            ...
            onPressed: () {
              ...
              if (amt > 0) {
                final newEntry = BankDepositEntry(
                  ...
                  referenceNumber: refController.text.trim().isNotEmpty
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                      content: Text('Deposit of ₹$amt recorded successfully.')),
                );
              }
            },
