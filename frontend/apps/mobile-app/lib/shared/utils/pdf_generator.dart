                ...
                pw.Row(
                  ...
                  children: [
                    pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                        pw.Text('Status: VERIFIED & CONFIRMED',
                            style: pw.TextStyle(
                                fontSize: 9,
                                color: PdfColors.green700,
                                fontWeight: pw.FontWeight.bold)),
                        pw.Text('Pauti Pustak Digital Sign-off',
                            style: pw.TextStyle(
                    ...
                    pw.Column(
                      ...
                      children: [
                        pw.Container(
                            width: 80, height: 1, color: PdfColors.grey800),
                        pw.SizedBox(height: 4),
                        pw.Text('Authorized Trustee',
