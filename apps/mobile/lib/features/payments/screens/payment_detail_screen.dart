        ...
        children: [
          ...
          AppCard(
            child: Column(
              ...
              children: [
                ...
                _DetailRow(icon: Icons.person_outline, label: 'Donor Name', value: payment.donorName),
                _DetailRow(
          ...
          if (payment.status == PaymentStatus.pendingMatch) ...[
            PermissionGuard(
              ...
              fallbackTooltip: 'Collector, Auditor or Admin role required to confirm QR match',
              child: AppButton(
          ...
          if (payment.status != PaymentStatus.voided) ...[
            PermissionGuard(
              ...
              fallbackTooltip: 'Auditor or Admin role required to void payment',
              child: AppButton(
