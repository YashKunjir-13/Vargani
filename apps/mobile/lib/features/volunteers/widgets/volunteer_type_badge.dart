...
class VolunteerTypeBadge extends StatelessWidget {
  const VolunteerTypeBadge({super.key, required this.type, this.customTypeLabel});
  ...
  Widget build(BuildContext context) {
    final label = type == VolunteerType.custom && customTypeLabel != null && customTypeLabel!.isNotEmpty
        ? customTypeLabel!
        : type.label;
    return Container(
